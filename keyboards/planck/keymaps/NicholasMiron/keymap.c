...
[_LOWER] = LAYOUT_planck_grid(
    _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_LPRN,    KC_RPRN,    KC_MINS, KC_PLUS, _______,
    _______, KC_GRV,  KC_TILD, KC_QUOT, KC_DQUO, KC_AMPR, KC_PIPE, KC_LCBR,    KC_RCBR,    KC_SLSH, KC_ASTR, _______,
    _______, _______, KC_UNDS, KC_LT,   KC_GT,   _______, _______, KC_LBRC,    KC_RBRC,    _______, _______, _______,
 ...
 * |      |      |      |scren4|scren5|      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | caps |      |      | prev |pause | next |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |capwrd|      |      | mute |Vol Dn|Vol Up|      |      |brit d|brit u|      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
